        ...
        eclipse=dict(
            install=dict(
                jvm=dict(
                    ...
                    macos_64=download_link(macos_icon, "macOS 64-bit", macos_64),
                    linux_64=download_link(linux_icon, "Linux 64-bit", linux_64),
                    windows_64=download_link(windows_icon, "Windows 64-bit", windows_64),
                    windows_32=download_link(windows_icon, "Windows 32-bit", windows_32),
                ),
                macos_64=macos_64,
                linux_64=linux_64,
